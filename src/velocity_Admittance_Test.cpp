...
int main(int argc, char** argv)
{
	...
	ros::Publisher Commandpub = n.advertise<dynamixel_workbench_msgs::DasomDynamixel>("/dasom/goal_dynamixel_position_to_VBP_node", 100); // Final Angle Command
...
//-----State Space Representation----//
	...
	ROS_INFO("position+from_model=%lf", position_from_model);
